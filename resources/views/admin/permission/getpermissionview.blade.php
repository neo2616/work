...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="ps_name"  autocomplete="off" placeholder="请输入权限名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
	...
	<div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="ps_c"  autocomplete="off" placeholder="请输入控制器名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">方法</label>
        <div class="layui-input-block">
            <input type="text" name="ps_a"  autocomplete="off" placeholder="请输入方法名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">路由</label>
        <div class="layui-input-block">
            <input type="text" name="ps_route"  autocomplete="off" placeholder="请输入路由名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            //AJAX
            $.ajax({
                url:'{{url("/permission/storepermission")}}',
                data:shuju,
                type:'post',
                dataType:'json',
                headers:{
